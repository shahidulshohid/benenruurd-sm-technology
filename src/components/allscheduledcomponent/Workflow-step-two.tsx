                                        ...
                                        <div
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">Request approval from the assignee to continue</p>
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">Request data from the assignee to continue</p>
                                                </div>
                                            </div>
                                            <MdKeyboardArrowRight className="text-gray-400" size={20} />
                                        </div>
