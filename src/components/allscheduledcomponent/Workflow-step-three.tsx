            ...
            <div className="rounded-br-lg rounded-lg shadow w-full p-0 border border-t-0">
              ...
              <div className="w-full p-4">
                ...
                <div className="relative">
                  <select
                    ...
                    className={`w-full p-2 border-2 rounded-lg text-sm font-semibold appearance-none bg-white pr-10 cursor-pointer ${
                      selectedOption === "Not Assigned"
              ...
              <div className="px-4 flex items-center gap-4">
                <div className="flex-1">
                  ...
                  <div className="relative">
                    <DatePicker
                      ...
                      className="w-full p-2 border-2 border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-blue-500 cursor-pointer"
                ...
                <div className="flex-1">
                  ...
                  <div className="relative">
                    <select className="w-full p-2 border-2 border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-blue-500 appearance-none bg-white pr-10 cursor-pointer">
              ...
              <div className="p-4 text-right">
                <button
                  type="submit"
                  className="bg-blue-500 text-white px-4 py-2 text-sm font-semibold rounded-md cursor-pointer"
                >
                  Done
                </button>
              </div>
