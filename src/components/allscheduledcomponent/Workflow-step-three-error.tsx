        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/2 space-y-4">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-2 rounded-lg">
              ...
              <div className="flex items-center gap-3">
                <Button variant="outline" className="flex items-center text-[#8588AB] hover:text-[#8588AB] gap-2 text-sm -mr-1">
                  Not Assigned
                </Button>
                <BsThreeDotsVertical className="text-gray-400" />
              </div>
                ...
                <form className="w-full">
                  ...
                  <div className="w-full p-4">
                    ...
                    <div className="relative">
                      ...
                      >
                        <option>Email</option>
                        <option>Slack</option>
                        <option className="text-[#8588AB]">Not Assigned</option>
                      </select>
                  ...
                  <div className="px-4 flex items-center gap-4">
                    <div className="flex-1">
                      <label className="block text-sm font-semibold text-[] mb-1">Due date</label>
                      <div className="relative">
                        <DatePicker
                          ...
                          minDate={new Date("2025-06-30T08:29:00+06:00")}
