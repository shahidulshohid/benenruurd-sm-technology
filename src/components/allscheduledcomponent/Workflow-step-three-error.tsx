...
const WorkflowStepThreeError = () => {
  ...
  const [selectedOption, setSelectedOption] = useState<string>("Email"); // Track selected option

  const handleSubmit = (e: React.FormEvent<HTMLFormElement>): void => {
    e.preventDefault();
    if (selectedOption === "Not Assigned") {
      console.log("No assignee selected");
      // You can also set an error state here if you want to manage it separately
    } else {
      console.log(e);
    }
  };
          ...
          <div className="w-full md:w-1/2 space-y-4">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-2 rounded-lg">
              ...
              <div className="flex items-center gap-3">
                <Button
                  variant="outline"
                  className="flex items-center text-[#8588AB] hover:text-[#8588AB] gap-2 text-sm -mr-1"
                >
                  Not Assigned
                </Button>
                <BsThreeDotsVertical className="text-gray-400" />
            ...
            {showTrigger && (
              <div className="rounded-br-lg rounded-lg shadow w-full p-0 border border-t-0">
                ...
                <form className="w-full">
                  ...
                  <div className="w-full p-4">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full p-2 border-2 rounded-lg text-sm text-[#22222F] font-semibold focus:outline-none focus:ring-1 focus:ring-blue-500 appearance-none bg-white pr-10"
                      >
                    ...
                    {selectedOption === "Not Assigned" && (
                      <p className="text-red-500 text-sm mt-1">No assignee selected</p>
                    )}
                  </div>

                  {/* Assignee */}
                  <div className="w-full p-4">
                    <h4 className="text-[#22222F] text-sm font-semibold mb-2">Assignee</h4>
                    <div className="relative">
                      <div className="w-full p-2 border-2 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-blue-500 appearance-none bg-white pr-10">
                        <div className="flex items-center gap-2">
                          <Image
                          ...
                          />
                          <span className="text-sm font-semibold text-[#22222F]">Ruben Vallt</span>
                        </div>
                      </div>
                      <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                        <FaChevronDown className="w-4 h-4" />
                  ...
                  {/* Message */}
                  <div className="p-4">
                    <h4 className="text-[#22222F] text-sm font-semibold mb-2">Message</h4>
                    <textarea
                  ...
                  <div className="px-4 flex items-center gap-4">
                    <div className="flex-1">
                      ...
                      <div className="relative">
                        <DatePicker
                          ...
                          minDate={new Date("2025-06-30T08:53:00+06:00")} // Updated to current time
                    ...
                    <div className="flex-1">
                      ...
                      <div className="relative">
                        <select
                          className="w-full p-2 border-2 border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-blue-500 appearance-none bg-white pr-10"
                        >
                  ...
                  <div className="px-4 py-2 mt-4 bg-blue-50 rounded-lg shadow-sm">
                    <h4 className="text-sm font-semibold text-[#22222F] mb-2">Preview</h4>
                    <p className="text-sm text-[#8588AB] mb-4">
                      Send yourself an example of the approval notification
                    </p>
                    <button className="px-4 py-2 bg-white border border-gray-300 rounded-md text-sm font-medium text-[#22222F] hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
